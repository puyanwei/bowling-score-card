...
describe('Multiple player tests', () => {
  ...
  context('Bowl box score interactions only', () => {
    it('pressing non spare or strike buttons renders the chosen numbers in the scorecard', () => {
      ...
      cy.get('player-1-frame-1-first-bowl').should('have.text', '0')
      cy.getById('button-1').click()
      cy.get('player-1-frame-1-second-bowl').should('have.text', '1')
      cy.getById('button-0').click()
      cy.get('player-2-first-bowl').should('have.text', '0')
      cy.getById('button-2').click()
      cy.get('player-2-first-bowl').should('have.text', '2')
      cy.getById('button-0').click()
      cy.get('player-1-first-bowl').should('have.text', '0')
      cy.getById('button-3').click()
      cy.get('@frame3bowl2').should('have.text', '3')
      cy.getById('button-0').click()
      cy.get('@frame4bowl1').should('have.text', '0')
      cy.getById('button-4').click()
      cy.get('@frame4bowl2').should('have.text', '4')
      cy.getById('button-0').click()
      cy.get('@frame5bowl1').should('have.text', '0')
      cy.getById('button-5').click()
      cy.get('@frame5bowl2').should('have.text', '5')
      cy.getById('button-0').click()
      cy.get('@frame6bowl1').should('have.text', '0')
      cy.getById('button-6').click()
      cy.get('@frame6bowl2').should('have.text', '6')
      cy.getById('button-0').click()
      cy.get('@frame7bowl1').should('have.text', '0')
      cy.getById('button-7').click()
      cy.get('@frame7bowl2').should('have.text', '7')
      cy.getById('button-0').click()
      cy.get('@frame8bowl1').should('have.text', '0')
      cy.getById('button-8').click()
      cy.get('@frame8bowl2').should('have.text', '8')
      cy.getById('button-0').click()
      cy.get('@frame9bowl1').should('have.text', '0')
      cy.getById('button-9').click()
      cy.get('@frame9bowl2').should('have.text', '9')
      cy.getById('button-0').click()
      cy.get('@frame10bowl1').should('have.text', '0')
