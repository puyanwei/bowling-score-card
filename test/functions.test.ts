...
describe('updateNextTwoBowls()', () => {
  ...
  it(`previous frame's next2bowls temporarily has an X when the current frame has one strike`, () => {
    updateNextTwoBowls(framesWithOneStrike, 3, 'X', '', false)
    expect(framesWithOneStrike[1].nextTwoBowls).toEqual(['X', ''])
  })
  ...
  it(`applies 2 bowls to the tuple array when there is a double strike`, () => {
    ...
    expect(framesWithADoubleStrike[1].nextTwoBowls).toEqual(['X', 'X'])
    expect(framesWithADoubleStrike[2].nextTwoBowls).toEqual(['X', '4'])
  ...
  it(`applies 2 bowls to the tuple array when there is a triple strike`, () => {
    ...
    expect(framesWithATripleStrike[0].nextTwoBowls).toEqual(['X', 'X'])
    expect(framesWithATripleStrike[1].nextTwoBowls).toEqual(['X', 'X'])
    expect(framesWithATripleStrike[2].nextTwoBowls).toEqual(['X', '4'])
